...
public:
	...
	// constructor
	// REQUIRE(base != NULL, "depot pointer is not NULL");
	...
	// ENSURE(this->getBuilding() == NULL, "FireTruck doesn't have building (yet)" );
	...
	// ENSURE(this->getBase() != NULL, "There must be an existing base");
	...
	// ENSURE(this->getBuilding() == NULL, "FireTruck has not a building to extinguish anymore");
