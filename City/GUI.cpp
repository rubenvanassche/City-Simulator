...
void GUI::start(){
	...
	std::cout << "7) Huizen laten branden(simulatie)" << std::endl;
	std::cout << "8) Winkels laten overvallen(simulatie)" << std::endl;
	std::cout << "9) Wagens laten rondrijden(simulatie)" << std::endl;
	std::cout << "10) Simpele uitvoer tonen" << std::endl;
	std::cout << "11) Grafische impressie tonen" << std::endl;
	std::cout << "12) 1 stap in de simulatie uitvoeren" << std::endl;
	std::cout << "13) Meerdere stappen in de simulatie uitvoeren" << std::endl;
	std::cout << "14) Afsluiten" << std::endl;
...
void GUI::burning(){
	...
	std::cout << "Huizen laten branden(simulatie)" << std::endl;
	std::cout << "-------------------------------" << std::endl << std::endl;
	...
	if ( (*simulator).burningDown() ) {
		...
		std::cout << "Er zijn geen brandende gebouwen." << std::endl << std::endl << std::endl;
	}
	return GUI::start();
}
...
void GUI::robbing(){
	...
	std::cout << "Winkels laten overvallen(simulatie)" << std::endl;
	std::cout << "-----------------------------------" << std::endl << std::endl;

	if ( (*simulator).robbing() ) {
		std::cout << "Winkels worden overvallen." << std::endl << std::endl << std::endl;
	}
	else {
		std::cout << "Er zijn geen winkels die overvallen worden." << std::endl << std::endl << std::endl;
	}
	return GUI::start();
}
...
void GUI::driveAround() {
	...
	std::cout << "Wagens laten rondrijden(simulatie)" << std::endl;
	std::cout << "----------------------------------" << std::endl << std::endl;
